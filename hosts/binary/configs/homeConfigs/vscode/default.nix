    ...
    profiles = {
      default = {
        userSettings = {
          ...
          # "languageToolLinter.external.apiKey" = config.sops.secrets.users_binary_languagetool_api_key.path;
          "languageToolLinter.external.url" = "https://api.languagetoolplus.com/v2/";
          # "languageToolLinter.external.username" = config.sops.secrets.users_binary_email.path;
